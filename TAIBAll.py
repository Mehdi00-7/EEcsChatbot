...
storage_context = StorageContext.from_defaults(persist_dir=Path("Embeddings/TAIBALL")) #Path to embeddings in local repositery these are stored in the embeddings folder and are named accordingly
