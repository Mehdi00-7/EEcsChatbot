...
storage_context = StorageContext.from_defaults(persist_dir=Path("Embeddings/TAIBIT")) #Path to embeddings in local repositery these are stored in the embeddings folder and are named accordingly
...
chat_engine = index.as_chat_engine(
    ...
    system_prompt=(
        ...
        seeking information about Queen Mary University of London. In particular but not limited to, questions regarding IT-related issues
